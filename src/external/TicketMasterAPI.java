...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "k5G7Gu2M1qhAByUjFTprBpYIpFpHAn9S";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// "apikey=k5G7Gu2M1qhAByUjFTprBpYIpFpHAn9S&latlong=37,-120&keyword=event&radius=50"
	...
	private String getDate(JSONObject event) throws JSONException {
		if (!event.isNull("dates")) {
			...
			if (!dates.isNull("start")) {
				...
				if (!start.isNull("dateTime")) {
					dateSB.append(start.getString("dateTime"));
				}
	...
	public static void main(String[] args) {
		...
		// Houston, TX
		tmApi.queryAPI(41.839303, -87.615865);
